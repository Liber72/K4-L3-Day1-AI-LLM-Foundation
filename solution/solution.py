...
# ===========================================================================
DEFAULT_PERSONA = (
    "Bạn là trợ lý kỹ thuật chuyên hỗ trợ lập trình viên, "
    "trả lời ngắn gọn, đưa ra các phương án phù hợp khác nhau "
    "và đánh giá các phương án đó."
)
...
if __name__ == "__main__":
    ...
    stats = run_assistant(
        persona="Bạn là trợ lý kỹ thuật chuyên hỗ trợ lập trình viên, "
                "trả lời ngắn gọn, đưa ra các phương án phù hợp khác nhau "
                "và đánh giá các phương án đó.",
    )
    print("\n--- Thống kê phiên chat ---")
